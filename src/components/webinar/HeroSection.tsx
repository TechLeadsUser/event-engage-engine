...
const HeroSection = () => {
  ...
  return <section className="relative bg-gradient-hero text-white py-20 px-4 overflow-hidden">
      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-left">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight lg:text-4xl">
              Fusion Procurement Masterclass
            </h1>
            
            <p className="text-xl mb-8 text-white/90 font-medium md:text-lg">
            ...
            <div className="flex flex-wrap gap-6 mb-10 text-lg">
              <div className="flex items-center gap-2">
                ...
                <span className="text-base">Nov 25, 2025</span>
              </div>
              <div className="flex items-center gap-2">
            ...
            <Button onClick={scrollToRegistration} size="lg" className="bg-accent hover:bg-accent/90 text-white font-semibold px-8 py-6 text-lg rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105">
          ...
          <div className="relative hidden md:block">
            <div className="rounded-2xl overflow-hidden shadow-2xl">
              <img src={heroImage} alt="Procurement Automation Dashboard" className="w-full h-auto object-cover" />
            </div>
          </div>
        </div>
      </div>
