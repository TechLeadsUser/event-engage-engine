...
const RegistrationSection = () => {
  ...
  return (
    <section id="registration" className="py-16 px-4 bg-secondary/30">
      <div className="container mx-auto max-w-7xl">
        ...
        <Card className="max-w-3xl mx-auto p-8 shadow-card">
          <div className="mb-6 p-4 bg-accent/10 border border-accent/20 rounded-lg flex items-start gap-3">
            ...
            <div>
              <p className="font-semibold text-foreground mb-1">Limited Seats Available</p>
              <p className="text-sm text-muted-foreground">
                Only <span className="font-bold text-accent">12 seats left</span> — secure your spot now!
              </p>
            </div>
          </div>
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              ...
              <Button 
                type="submit" 
                size="lg"
                className="w-full bg-gradient-cta hover:opacity-90 text-white font-semibold text-lg py-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300"
