        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <Card className="bg-card p-6 shadow-card hover:shadow-hover transition-shadow duration-300">
            ...
            <div className="space-y-4">
              {facts.map((fact, index) => <div key={index} className="flex items-center gap-3">
                  <div className="w-10 h-10 bg-accent/10 flex items-center justify-center flex-shrink-0 rounded-xl">
